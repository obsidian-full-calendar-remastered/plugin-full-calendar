...
## 2. Local Notes: Frontmatter Header Cards

When editing a dedicated Local Note (FullNote) in Live Preview, the complex and text-heavy YAML frontmatter section at the top of the file can be distracting. The plugin automatically generates an **Elegant Metadata Header Card** block widget at the very top of the note:
